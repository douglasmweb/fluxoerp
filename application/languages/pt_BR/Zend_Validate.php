...
return array(
    ...
    "A record with the supplied identity could not be found."=>"Um registro com a identidade fornecida não pôde ser encontrado.",
    "Authentication successful."=>"Autenticação Bem-sucedida.",
    "Supplied credential is invalid."=>"Credencial fornecida é inválida.",
